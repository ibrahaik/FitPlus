...
export const db = getDatabase(app);           // Realtime Database (chats)
export const storage = getStorage(app);       // Firebase Storage (vídeos)
export const firestore = getFirestore(app);   // Firestore (metadatos)
